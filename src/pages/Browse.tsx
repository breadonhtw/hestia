            ...
            <div className="bg-[#F5F0E8] rounded-xl p-6 shadow-soft sticky top-24 border border-border/30">
              ...
              <div className="mb-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    <Label htmlFor="just-browsing" className="text-sm cursor-pointer">
                      Just Browsing
                    </Label>
                    <Switch
                      id="just-browsing"
                      checked={justBrowsing}
                      onCheckedChange={setJustBrowsing}
                    />
                  </div>
                </div>
              </div>
              ...
              <Button
                ...
                className="text-secondary p-0 h-auto mb-4 underline"
              >
                Clear All Filters
              </Button>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {filteredCreators.map((creator, index) => (
                  <CreatorCard 
                    ...
                    creator={creator} 
                    index={index}
                    isExpanded={expandedCard === creator.id}
                    onToggleExpand={() => setExpandedCard(expandedCard === creator.id ? null : creator.id)}
                  />
                ))}
              </div>
            ) : (
